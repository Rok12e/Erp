...
{
    public partial class frmSalesByCustomerSummary : Form
    {
        string tblName = "tbl_sales";
        string tblDetailName = "tbl_sales_details";
        public frmSalesByCustomerSummary()
        {
            InitializeComponent();
            LocalizationManager.LocalizeForm(this);
            headerUC1.FormText = this.Text;
        }
        private void frmSalesByCustomerSummary_Load(object sender, EventArgs e)
        {
            comboBox2.Text = "Sales";
            btnPrint.Text = "Print ▼";
            LoadSalesData();
        ...
        private void LoadSalesData()
        {
            ...
            using (MySqlDataReader reader = DBClass.ExecuteReader(query, 
                DBClass.CreateParameter("fromDate", dtpFrom.Value.Date),
                DBClass.CreateParameter("toDate", dtpTo.Value.Date)))
            {
                while (reader.Read())
                {
                    int sn = Convert.ToInt32(reader["SN"]);
                    string name = reader["customer_name"].ToString();
                    decimal netSales = Convert.ToDecimal(reader["Total Sales"]);
                    int rowIndex = dgvSales.Rows.Add(reader["customer_id"].ToString(), sn, name, netSales.ToString("N2"), "0.00", "0.00");
        ...
        private void SavePDF_Click(object sender, EventArgs e)
        {
            ...
            center.AddFormattedText("Sales By Customer Summary\n", TextFormat.Bold).Font.Size = 12;
            ...
            using (SaveFileDialog saveDialog = new SaveFileDialog())
            {
                ...
                saveDialog.Title = "Save Customer Summary PDF";
                saveDialog.FileName = "SalesByCustomerSummary.pdf";
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog saveDialog = new SaveFileDialog())
            {
                ...
                saveDialog.FileName = "SalesByCustomerBalanceSummary.xlsx";
                ...
                if (saveDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    worksheet.Name = "Sales By Customer Balance";
        ...
        private void dgvSales_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            frmLogin.frmMain.openChildForm(new frmSalesByCustomerDetails(id,tblName));
        }
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if(comboBox2.Text == "Quotation")
            {
                tblName = "tbl_sales_quotation";
            }
            else if (comboBox2.Text == "Performa")
            {
                tblName = "tbl_sales_proforma";
            }
            else if (comboBox2.Text == "Order")
            {
                tblName = "tbl_sales_order";
            }
            else if (comboBox2.Text == "Return")
            {
                tblName = "tbl_sales_return";
            }
            LoadSalesData();
        }
