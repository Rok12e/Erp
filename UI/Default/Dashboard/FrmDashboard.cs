...
using YamyProject.Domain.Models;
    ...
    public partial class FrmDashboard : Form
    {
        ...
        private void LoadData()
        {
            ...
            if (refreshData == true)
            {
                ...
                lblTotalRevenue.Text = model.TotalRevenue.ToString("F2");
                lblTotalProfit.Text = model.TotalProfit.ToString("F2");
        ...
        private void SetDateMenuButtonUI(object button)
        {
            ...
            btn.BackColor = btnLast30Days.BorderColor;
