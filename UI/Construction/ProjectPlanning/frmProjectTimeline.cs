...
{
    public partial class frmProjectTimeLine : Form
    {
        ...
        private void frmProjectTimeLine_Load(object sender, EventArgs e)
        {
            //
        }
        ...
        private void objectsReinitializeButton_Click(object sender, EventArgs e)
        {
            ...
            using(MySqlDataReader readActivity = DBClass.ExecuteReader(query1, DBClass.CreateParameter("planId", planId)))
            {
        ...
        private void standardShowGridCheckBox_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void dataTableFixedGridCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            ganttChartViewSplitContainer.FixedPanel = checkBox.Checked ? FixedPanel.Panel1 : FixedPanel.None;
        }

        private void objectsScaleComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ComboBox comboBox = sender as ComboBox;
            ganttChartView.ScaleType = (ScaleType)comboBox.SelectedIndex;
        }

        private void objectsUpdateScaleComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ComboBox comboBox = sender as ComboBox;
            ganttChartView.UpdateScaleType = (UpdateScaleType)comboBox.SelectedIndex;
        }

        private void standardCalendarComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ComboBox comboBox = sender as ComboBox;
        ...
        private void dataTableColorComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ComboBox comboBox = sender as ComboBox;
        ...
        private void objectsShowIconsCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            ganttChartView.ShowGanttIconImages = checkBox.Checked;
        }

        private void dataTableShowMarkersCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
        ...
        private void objectsShowToolTipsCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            ganttChartView.ShowToolTips = checkBox.Checked;
        }

        private void objectsShowResourcesCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            ganttChartView.ShowAssignments = checkBox.Checked;
        }

        private void standardShowDependenciesCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
        ...
        private void standardShowExtraDaysCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            ganttChartView.ShowNonworkingDays = checkBox.Checked;
        }

        private void dataTableShowExtraDaytimeCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            ganttChartView.ShowNonworkingDaytime = checkBox.Checked;
        }

        private void objectsHighlightCriticalTasksCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            ganttChartView.HighlightCriticalTasks = checkBox.Checked;
        }

        private void standardShowBaselineCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = sender as CheckBox;
            ganttChartView.ShowPlannedValues = checkBox.Checked;
        }

        private void dataTablePageSetupButton_Click(object sender, EventArgs e)
        {
            ganttChartView.PageSetup();
        }

        private void objectsPrintPreviewButton_Click(object sender, EventArgs e)
        {
            ganttChartView.PrintPreview();
        }
        private void standardExpandButton_Click(object sender, EventArgs e)
        {
        ...
        private void standardIncreaseIndentButton_Click(object sender, EventArgs e)
        {
            int rowIndex = ganttChartView.TasksTreeGrid.CurrentRow.Index;
        ...
        private void standardDecreaseIndentButton_Click(object sender, EventArgs e)
        {
            int rowIndex = ganttChartView.TasksTreeGrid.CurrentRow.Index;
        ...
        private void standardSetIconComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ComboBox comboBox = sender as ComboBox;
        ...
        private void standardClearButton_Click(object sender, EventArgs e)
        {
            duringInitialization = true;
