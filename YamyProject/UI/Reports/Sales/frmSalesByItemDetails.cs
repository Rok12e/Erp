...
{
    public partial class frmSalesByItemDetails : Form
    {
        int _itemId;
        public frmSalesByItemDetails(int itemId)
        {
            InitializeComponent();
        ...
        private void frmSalesByItemDetails_Load(object sender, EventArgs e)
        {
            btnPrint.Text = "Print ";
        ...
        private void LoadInvoicesForItem(int itemId, int insertIndex)
        {
            string sql = @"
                        ...
                        JOIN 
                        tbl_sales s ON sd.sales_id = s.id
                        JOIN 
                        tbl_item_category ic ON i.category_id = ic.id
                        WHERE 
            ...
            foreach (DataRow row in invoices.Rows)
            {
                dgvSales.Rows.Insert(insertIndex + 1, "n", "l", "4", "",
                    ...
                    row["qty"], row["price"], row["amount"], row["balance"], row["sales_id"]);
                insertIndex++;
            }
        }
        private void dgvSales_CellClick(object sender, DataGridViewCellEventArgs e)
        {
                    ...
                    else if (currLvl == 2)
                    {
                        ...
                        string sql = @"
                                    SELECT 
                                        ...
                                        s.invoice_id AS num,
                                        s.bill_to AS customer,
                                        CONCAT(i.type,' - ' ,ic.name, ' - ',i.name ) AS memo,
                                        sd.qty,
                                        sd.price,
                                        sd.total AS amount,
                                        (sd.qty * sd.price) - sd.discount AS balance
                     ...
                     else if (currLvl == 3)
            {
                ...
                if (int.TryParse(key, out itemId))
                {
                    ...
                    DataTable invoices = DBClass.ExecuteDataTable(sql, 
    ...
    else if (state == "c")
    {
        ...
        private void dgvSales_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                frmLogin.frmMain.openChildForm(new frmSales(salesId));  // 🔹 Pass the sales_id here
            }
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            FormattedText titleText = center.AddFormattedText("Sales By Item Details\n", TextFormat.Bold);
            ...
            using (SaveFileDialog saveFile = new SaveFileDialog())
            {
                ...
                saveFile.FileName = "SalesByItemDetails.pdf";
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog saveDialog = new SaveFileDialog())
            {
                ...
                saveDialog.FileName = "SalesByItemDetails.xlsx";
                ...
                if (saveDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    worksheet.Name = "Sales Item Details";
