...
{
    public partial class frmViewProgressSummary : Form
    {
        private string type;

        public frmViewProgressSummary(string _type="")
        {
            InitializeComponent();
        ...
        private void frmViewProgressSummary_Load(object sender, EventArgs e)
        {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            if (dgvItems.Rows.Count > 0)
            {
                GeneratePDF(dgvItems, "Project Progress Summary");
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            if (dgvItems.Rows.Count > 0)
            {
                GenerateExcel(dgvItems, "Project Progress Summary");
